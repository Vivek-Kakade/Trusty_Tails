...
public class AdminProviderController {
	...
	public ResponseEntity<?> getUserPassword(@PathVariable String email){
		...
		if(cust==null) {
			return ResponseEntity.ok("Provider with this email doesn't exist!");
		}
		else {
		String userPassword=cust.getPassword();
		emailSenderService.sendSimpleEmail(email, "Your password for TrustyTails is "+userPassword, "TrustyTails login password");
